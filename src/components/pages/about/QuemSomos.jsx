...
const QuemSomos = () => (
    <Container className="container-quemsomos">
        ...
        <h3 className="title-3 text-align-center padding-v-15">Trabalhamos em parceria presencial com empreendedores,
            ...
            gerenciamento das atividades financeiras, comerciais, operacionais e administrativas. Nossa equipe atua 
            com os clientes, a fim de identificar os 6 pilares ligados a melhoria dos resultados. Esses pilares são: 
            pessoas, métodos, processos, planejamento, indicadores e tecnologia. Em uma economia competitiva e dinâmica, 
            é cada vez mais importante que a Gestão de um negócio se adapte às novas realidades exigidas pelo mercado 
